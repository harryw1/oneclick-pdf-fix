...
import { Download, Zap, Shield, Clock, Star, ArrowRight, Sparkles, CheckCircle2, Upload } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
          <div className="text-center mb-12 sm:mb-16 animate-fade-in">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
              Transform poorly scanned documents into professional, readable PDFs. 
            ...
            {user ? (
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Or <Link href="/dashboard" className="text-primary-600 hover:underline">view your dashboard</Link> to see previous results
                </p>
              </div>
            ) : (
              <div className="space-y-4">
