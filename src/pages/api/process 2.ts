...
export default async function handler(
  ...
  try {
    ...
    // Basic processing (OCR rotation detection temporarily disabled for performance)
    console.log('Applying basic PDF optimization...');
    
    // TODO: Re-enable smart rotation detection in background processing
    console.log('Skipping rotation detection for performance (will be re-enabled in future update)');

    // Temporarily disable deskewing for performance
    if (options.deskew) {
      console.log('Deskewing temporarily disabled for performance (will be re-enabled in future update)');
    }
